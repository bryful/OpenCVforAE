...
//-----------------------------------------------------------------------------------
inline PF_Pixel16 PIXEL_CONV8TO16(PF_Pixel c)
{
	PF_Pixel16 r;
...
//-----------------------------------------------------------------------------------
inline PF_Pixel PIXEL_CONV16TO8(PF_Pixel16 c)
{
...
//-------------------------------------------------------------------------------------------------
inline PF_PixelFloat PIXEL_CONV8TO32(PF_Pixel c)
{
	PF_PixelFloat r;
...
//-------------------------------------------------------------------------------------------------
inline PF_PixelFloat PIXEL_CONV16TO32(PF_Pixel16 c)
{
	PF_PixelFloat r;
...
//-------------------------------------------------------------------------------------------------
inline PF_Pixel PIXEL_CONV32TO8(PF_PixelFloat c)
{
	PF_Pixel r;
...
//-------------------------------------------------------------------------------------------------
inline PF_Pixel16 PIXEL_CONV32TO16(PF_PixelFloat c)
{
	PF_Pixel16 r;
